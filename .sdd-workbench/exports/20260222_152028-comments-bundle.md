...
## Comments
### _sdd/drafts/feature_draft_f11_2_spec_jump_scroll_retention_and_collapsed_marker_bubbling.md:L10-L10

test comment

- anchor.hash: 98872ed4
- anchor.snippet: # Part 1: Spec Patch Draft
- createdAt: 2026-02-22T05:18:18.411Z

### _sdd/drafts/feature_draft_f12_4_header_action_layout_reorder.md:L12-L15

테스트 코멘트

- anchor.hash: e6078407
- anchor.snippet: > 이 패치는 스펙 문서의 해당 섹션에 copy-paste하거나,
> `spec-update-todo` 스킬 입력으로 사용할 수 있습니다.

# Spec Update Input
- createdAt: 2026-02-22T06:04:49.305Z

### _sdd/drafts/feature_draft_f12_4_header_action_layout_reorder.md:L17-L19

코드 테스트 코멘트

- anchor.hash: 5c970dbb
- anchor.snippet: **Date**: 2026-02-22
**Author**: Codex
**Target Spec**: main.md
- createdAt: 2026-02-22T06:08:23.134Z
