...
function registerIpcHandlers() {
  ...
  const handlerTable: Array<[string, IpcHandler]> = [
    ...
    [IPC_CHANNELS.WORKSPACE_SEARCH_TEXT, handleWorkspaceSearchTextRouted],
    ...
    [IPC_CHANNELS.WORKSPACE_WATCH_SET_FOCUSED_PATHS, handleWorkspaceWatchSetFocusedPathsRouted],
