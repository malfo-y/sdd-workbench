...
```text
┌──────────────────────────────────────────────────────────────────┐
│ Top Action Row: Workspace Switcher | Close/Open Workspace | F08 │
├──────────────────┬─────────────────────────┬─────────────────────┤
...
| 항목 | 내용 |
|---|---|
| Purpose | 워크스페이스/스펙 액션 + 코드/트리 컨텍스트 복사 액션 제공 |
...
| 상태 | Partial (F06.1/F06.2 컨텍스트 복사 통합 Implemented, F08/F09 Planned) |
