...
4. Back/Forward(mouse/swipe/wheel) 동작
5. CodeViewer/SpecViewer에서 Add Comment + marker 표시
6. Export Comments pending-only 및 partial success 배너
