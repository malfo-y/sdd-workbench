...
**Target Section**: `/_sdd/spec/sdd-workbench/product-overview.md` > `3.1 MVP 포함 범위`, `3.2 MVP 제외 범위`, `5. 현재 기능 커버리지 요약`; `/_sdd/spec/sdd-workbench/system-architecture.md` > `4.1 Workspace 세션 상태`, `5.1 Workspace 부팅/전환`; `/_sdd/spec/sdd-workbench/contract-map.md` > `1. 핵심 타입 계약`, `3. IPC 계약`
...
**Priority**: Medium
**Target Section**: `/_sdd/spec/sdd-workbench/system-architecture.md` > `4.1 Workspace 세션 상태`; `/_sdd/spec/sdd-workbench/operations-and-validation.md` > `3. 신뢰성 기준`
